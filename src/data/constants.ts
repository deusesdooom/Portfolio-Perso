...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Doom Secured",
    description: [
      "Leading advanced cybersecurity operations focused on proactive defense, threat intelligence, and risk mitigation.",
      "Designing and deploying secure infrastructures for enterprise clients.",
      "Conducting high-level penetration testing and security assessments.",
      "Delivering end-to-end security solutions tailored to client environments.",
      "Spanning offensive security, defensive architecture, and strategic protection of critical systems.",
    ],
    skills: [
      SkillNames.LINUX,
      SkillNames.DOCKER,
  ...
  },
  {
    ...
    company: "Microsoft",
    description: [
      "Worked alongside Microsoft's cybersecurity incident response team on real-time threat analysis.",
      "Conducted proactive security monitoring and incident response planning.",
      "Gained hands-on exposure to enterprise-grade cyber defense operations.",
      "Analyzed evolving threat landscapes and documented attack patterns.",
      "Strengthened technical skills and strategic security thinking in production environments.",
    ],
    skills: [
      SkillNames.LINUX,
      SkillNames.GIT,
